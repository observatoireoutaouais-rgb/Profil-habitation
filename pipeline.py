...
def main():
    ...
    print(f"Après expansion : {len(Role_exp):,}")
    ...
    save_json(Role_exp.groupby(["Annee","CDNAME","CSDNAME","Types"]).agg(N=("Annee","count")).reset_index().rename(columns={"Types":"Types de construction résidentielle","N":"Nombre de logements"}),"logements_types_mun.json")
