...
def main():
    ...
    # 9. Superficie MRC (NEW)
    mrc_sup=Role_UE.groupby(["Annee","CDNAME","Types"]).agg(superficie_terrain=("rl0302a","mean"),aire_etages=("rl0308a","mean")).reset_index()
    tot_sup=Role_UE.groupby(["Annee","CDNAME"]).agg(superficie_terrain=("rl0302a","mean"),aire_etages=("rl0308a","mean")).reset_index()
    ...
    # 10. Superficie MUN (NEW)
    save_json(Role_UE.groupby(["Annee","CDNAME","CSDNAME","Types"]).agg(superficie_terrain=("rl0302a","mean"),aire_etages=("rl0308a","mean")).reset_index().round(1),"superficie_mun.json")
