...
INDEX_URLS = {
    ...
    2025: "https://donneesouvertes.affmunqc.net/role/indexRole2025.csv",
    2024: "https://donneesouvertes.affmunqc.net/role/indexRole2024.csv",
    2023: "https://donneesouvertes.affmunqc.net/role/indexRole2023.csv",
    2022: "https://donneesouvertes.affmunqc.net/role/indexRole2022.csv",
    2021: "https://donneesouvertes.affmunqc.net/role/indexRole2021.csv",
    2020: "https://donneesouvertes.affmunqc.net/role/indexRole2020.csv",
}
...
def build_role_df(annees, match_df, pause=0.1):
    """Télécharge le rôle de CHAQUE année séparément — rôle 2021 pour logements 2021, etc."""
